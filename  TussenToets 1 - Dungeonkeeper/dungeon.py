...
while Kamer2_deur == 6 and kamer6_zombie_gezien == False:
    ...
    if zombie_hit_damage <= 0:
        ...
        kamer6_zombie_gezien = True
    print('')
    time.sleep(1)


# === [kamer 3] === #
if Kamer2_deur == 3 and kamer3_item_gepakt == False:
